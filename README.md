...
**Species:**  capuchin monkeys (*Sapajus spp.*)  
...
├── data/
│   ├── raw/TIL_Master_File      # Raw trial-by-trial output files per subject
│ 
├── analysis/
│   ├── TIL_Analysis.Rmd         # Primary GLMM models
└── outputs/
    ├── figures/Figure_1_Trial_Type
    ├── figures/Figure_2_Ordinal_Position
    ├── figures/Figure_3_Critical_Pairs
...
Note: Items C and E are **overlap/bridge items** shared between sequences.
...
### Deferred Reinforcement Training
Subjects were transitioned to deferred reinforcement before testing. Feedback was withheld and provided only after every N trials, gradually increasing:
Each step required ≥80% accuracy across 2 consecutive blocks before advancing.
